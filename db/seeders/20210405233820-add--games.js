...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const games = [
      ...
      { title: 'Horizon Zero Dawn', publisher: 'Sony Interactive Entertainment', developer: 'Guerilla Games', releaseDate: '2017-02-28', description: 'In a world where technology could threaten your very existence how will you wield it\'s power?', overallRating: 4.2, imageHref: '/images/horizon_zero_dawn.jpg', createdAt: new Date(), updatedAt: new Date() },
